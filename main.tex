...
\label{fig:lc_example}
 ...
 \cprotect\caption{A plot showing an example lightcurve for an object id 217720894888346422. The vertical blue dashed lines mark Jan 1st of each year, and red dashed vertical line marks Sept 1st of 2005, when SDSS-III Supernova Survey commenced. All points to the left of the red line are averaged together, and all points to the right are annually averaged.  }
\end{figure}
