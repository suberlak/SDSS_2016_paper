...
\begin{equation}
    x_{0}=
    \begin{cases}
      -x_{obs}, & \text{if}\ x_{obs} > 0 \\
      x_{obs}, & \text{otherwise}
    \end{cases}
\end{equation}
